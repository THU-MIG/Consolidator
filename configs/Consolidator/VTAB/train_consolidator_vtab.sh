...
LRS=("0.001" "0.002" "0.002" "0.002" "0.01" "0.001" "0.002" "0.005" "0.002" "0.005" "0.001" "0.001" "0.0005" "0.005" "0.005" "0.005" "0.01" "0.01" "0.0005")
WEIGHT_DECAYS=("0" "0.01" "0.1" "0.01" "0.001" "0.001" "0" "0.01" "0.01" "0.1" "0.1" "0.0001" "0.01" "0.01" "0.001" "0.1" "0.001" "0.1" "0.1")
DRS=("0.8" "0.2" "0.8" "0.8" "0.5" "0.8" "0.8" "0.2" "0.0" "0.0" "0.8" "0.2" "0.5" "0.8" "0.0" "0.8" "0.8" "0.8" "0.2")
GROUP="384"
...
do
  ...
  DR=${DRS[${i}]}
  DATASET=${DATASETS[${i}]}
  CONFIG=experiments/Consolidator/ViT-B_prompt_consolidator_${GROUP}.yaml
  TARGET_DIR=./saves/${DATASET}_lr-${LR}_wd-${WEIGHT_DECAY}_consolidator_g${GROUP}_d${DR}
  if [ ! -d ${TARGET_DIR} ]
  then
    mkdir ${TARGET_DIR}
  else
